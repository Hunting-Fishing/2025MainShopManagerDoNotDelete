...
export default function WaterDeliveryStore() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-background py-12 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 px-4 py-2 rounded-full mb-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
            Professional equipment trusted by water delivery experts. 
