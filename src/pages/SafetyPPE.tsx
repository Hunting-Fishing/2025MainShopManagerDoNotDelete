...
import { HardHat, Package, Users, AlertTriangle, Search } from 'lucide-react';
...
const SafetyPPE = () => {
  const { inventory, assignments, loadingInventory, loadingAssignments } = usePPEManagement();
    ...
    <div className="container mx-auto p-4 md:p-6 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Track and manage personal protective equipment</p>
        </div>
      ...
      <div className="relative">
        ...
        <Input
          placeholder="Search PPE items or employees..."
          value={searchTerm}
