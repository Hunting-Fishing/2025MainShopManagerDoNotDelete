...
export default function Developer() {
  const developerModules = [
    ...
    {
      id: "service-data-debug",
      title: "Service Data Debug", 
      description: "Debug and analyze service data issues",
      icon: <Bug className="h-6 w-6 text-red-600" />,
      href: "/debug/service-data",
    },
    {
      id: "database-tools",
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-10 p-4 border border-amber-300 bg-amber-50 dark:bg-amber-900/20 dark:border-amber-700 rounded-xl">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-amber-800 dark:text-amber-400">Real Data Only</h3>
        </div>
        <p className="mt-2 text-amber-700 dark:text-amber-300">
          All tools in this console work exclusively with live, real data from your connected database. No mock or sample data is used.
        </p>
      </div>
    </div>
  );
