...
interface ManualPartEntryDialogProps {
  workOrderId: string;
  jobLineId?: string;
  onPartAdd: (part: Omit<WorkOrderPart, 'id' | 'created_at' | 'updated_at'>) => void;
}

export function ManualPartEntryDialog({ workOrderId, jobLineId, onPartAdd }: ManualPartEntryDialogProps) {
