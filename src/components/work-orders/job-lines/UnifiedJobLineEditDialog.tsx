  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Edit Job Line: {jobLine.name}</DialogTitle>
        </DialogHeader>
        
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Primary Editing Fields - Hours, Rate, Status */}
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="estimated_hours" className="text-base font-medium">Estimated Hours</Label>
                <Input
                  id="estimated_hours"
                  type="number"
                  step="0.25"
            ...
            <div>
              <Label htmlFor="labor_rate_type" className="text-base font-medium">Rate Type</Label>
              <Select 
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <Label htmlFor="labor_rate" className="text-base font-medium">Labor Rate ($)</Label>
            ...
            <div className="p-4 bg-primary/5 rounded-lg border-2 border-primary/20">
              ...
              <p className="text-sm text-muted-foreground">
                {formData.estimated_hours || 0} hours × ${(formData.labor_rate || 0).toFixed(2)}/hr
              </p>
            </div>
          </div>
