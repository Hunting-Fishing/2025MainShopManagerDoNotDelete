...
import { WorkOrderJobLine, isValidJobLineStatus, isValidLaborRateType, JobLineStatus, LaborRateType } from '@/types/jobLine';
...
export function UnifiedJobLineEditDialog({
  ...
  const statusOptions: { value: JobLineStatus; label: string }[] = [
  ...
  const laborRateOptions: { value: LaborRateType; label: string }[] = [
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor="labor-rate-type">Labor Rate Type</Label>
            <Select
              value={formData.labor_rate_type}
              onValueChange={(value) => setFormData({ ...formData, labor_rate_type: value as LaborRateType })}
            >
              <SelectTrigger>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => setFormData({ ...formData, status: value as JobLineStatus })}
            >
              <SelectTrigger>
