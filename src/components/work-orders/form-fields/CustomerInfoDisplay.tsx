...
import { User, Phone, Mail, MapPin, Car, Wrench, Eye, List } from "lucide-react";
...
export const CustomerInfoDisplay: React.FC<CustomerInfoDisplayProps> = ({
  ...
  const [viewMode, setViewMode] = useState<'info' | 'services'>('info');
  ...
  return (
    <div className="space-y-4">
      ...
      {viewMode === 'info' ? (
        ...
        <div className="space-y-4">
          <ServiceCategoriesView showSelectionMode={false} />
        </div>
      )}
    </div>
  );
