...
import { InvoiceItem, Invoice, convertToTemplateItems, InvoiceTemplate, InvoiceTemplateItem } from '@/types/invoice';
...
export function SaveTemplateDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateItems: InvoiceTemplateItem[] = convertToTemplateItems(currentInvoice.items);
