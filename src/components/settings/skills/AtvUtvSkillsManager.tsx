  ...
  const [categories, setCategories] = useState([
    {
      ...
      skills: ['Polaris', 'Can-Am (BRP)', 'Yamaha']
    },
    {
      name: 'Work Utility ATV/UTV',
      skills: ['John Deere Gator', 'Kubota RTV', 'Bobcat Utility Vehicles']
    },
    {
      name: 'European & Niche ATV/UTV',
      skills: ['TGB (Taiwan Golden Bee)', 'Access Motor', 'GOES']
    }
  ]);
  ...
  const handleAddCategory = () => {
    if (newCategoryName.trim()) {
      ...
      toast({
        ...
        description: "New ATV/UTV category has been created"
      });
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-medium">ATV/UTV Skills Categories</h3>
        <Button 
          variant="outline" 
